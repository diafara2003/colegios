let _lstcategoriasColores = [], _tipo_perfil = {};


function cargarGrupoEnvios() {
    consultarAPI('GrupoEnvio', 'GET', (_response) => {
        _lstcategoriasColores = _response;
        cargar_grupos_envio_colores(_response);
    });
}
function cargar_grupos_envio_colores(_response) {
    let _html = '';
...
function actualizar_color(_index) {
    consultarAPI('GrupoEnvio', 'POST', (response) => {

        _lstcategoriasColores = response;
        cargar_grupos_envio_colores(_response);
